...
public abstract class PostgresContext<TDatabase> where TDatabase : DbContext
{
    ...
    protected PostgresContext(string containerImage = "postgres:latest", ushort port = 5432)
    {
